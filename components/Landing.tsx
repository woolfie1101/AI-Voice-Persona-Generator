  ...
  return (
    <div className="text-center p-8 bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 animate-fade-in transition-colors duration-300">
      ...
      <p className="text-gray-600 dark:text-gray-300 text-lg mb-10 max-w-md mx-auto">
        Choose a generator to begin your creative journey.
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Persona Generator Card */}
        <div 
          className="p-8 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/50 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center"
        >
